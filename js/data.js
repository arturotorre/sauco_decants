...
const PERFUMES_COMPLETOS = [
  ...
  { casa: "Valentino", categoria: "disenador", nombre: "Uomo Born In Roma Intense", concentracion: "EDP", genero: "Caballero", imagen: "imagenes/completos/uomo_born_in_roma_intense.webp", alt: "Uomo Born In Roma Intense", precio: "$3,450" },
  ...
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "One Million", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/one_million_edt.webp", alt: "One Million", precio: "$2,100" },
  { casa: "Montblanc", categoria: "disenador", nombre: "Explorer", concentracion: "EDP", genero: "Caballero", imagen: "imagenes/completos/explorer.webp", alt: "Explorer", precio: "$1,950" },
  { casa: "Jean Paul Gaultier", categoria: "disenador", nombre: "Le Beau Le Parfum", concentracion: "EDP", genero: "Caballero", imagen: "imagenes/completos/le_beau_le_parfum.webp", alt: "Le Beau Le Parfum", precio: "$2,699" },
  { casa: "Jean Paul Gaultier", categoria: "disenador", nombre: "Le Beau", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/le_beau_edt.webp", alt: "Le Beau", precio: "$2,299" },
  { casa: "Jean Paul Gaultier", categoria: "disenador", nombre: "Le Male", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/le_male_edt.webp", alt: "Le Male", precio: "$2,199" },
  { casa: "Versace", categoria: "disenador", nombre: "Eros", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/eros_edt.webp", alt: "Eros EDT", precio: "$1,999" },
  ...
  { casa: "Jean Paul Gaultier", categoria: "disenador", nombre: "Scandal Intense", concentracion: "EDP", genero: "Caballero", imagen: "imagenes/completos/scandal_intense.webp", alt: "Scandal Intense", precio: "$2,590" },
  { casa: "Giorgio Armani", categoria: "disenador", nombre: "Acqua Di Gio", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/acqua_di_gio.webp", alt: "Acqua Di Gio", precio: "$2,100" },
  { casa: "Giorgio Armani", categoria: "disenador", nombre: "Stronger With You", concentracion: "Parfum", genero: "Caballero", imagen: "imagenes/completos/stronger_with_you.webp", alt: "Stronger With You", precio: "$2,275" },
  { casa: "Valentino", categoria: "disenador", nombre: "Uomo Born In Roma Coral Fantasy", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/uomo_born_in_roma_coral_fantasy.webp", alt: "Uomo Born In Roma Coral Fantasy", precio: "$2,800" },
  { casa: "Valentino", categoria: "disenador", nombre: "Uomo", concentracion: "EDT", genero: "Caballero", imagen: "imagenes/completos/uomo.webp", alt: "Uomo", precio: "$2,580" },
  ...
  { casa: "Prada", categoria: "disenador", nombre: "Paradoxe Intense", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/paradoxe_intense.webp", alt: "Paradoxe Intense", precio: "$2,950" },
  { casa: "Dior", categoria: "disenador", nombre: "J'adore Parfum d'Eau", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/jadore_parfum_deau.webp", alt: "J'adore Parfum d'Eau", precio: "$3,300" },
  { casa: "Adolfo Domínguez", categoria: "disenador", nombre: "Jazmín Tonka", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/jazmin_tonka.webp", alt: "Jazmín Tonka", precio: "$1,500" },
  { casa: "Salvatore Ferragamo", categoria: "disenador", nombre: "Signorina Unica", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/signorina_unica.webp", alt: "Signorina Unica", precio: "$2,100" },
  { casa: "Salvatore Ferragamo", categoria: "disenador", nombre: "Signorina Libera", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/signorina_libera.webp", alt: "Signorina Libera", precio: "$2,050" },
  { casa: "Carolina Herrera", categoria: "disenador", nombre: "Very Good Girl Elixir", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/very_good_girl_elixir.webp", alt: "Very Good Girl Elixir", precio: "$2,990" },
  ...
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "Olympéa", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/olympea.webp", alt: "Olympéa", precio: "$2,500" },
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "Lady Million", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/lady_million.webp", alt: "Lady Million", precio: "$2,500" },
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "Olympéa Parfum", concentracion: "EDP", genero: "Dama", imagen: "imagenes/completos/olympea_parfum.webp", alt: "Olympéa Parfum", precio: "$2,700" },
  { casa: "Tom Ford", categoria: "disenador", nombre: "Black Orchid", concentracion: "EDP", genero: "Unisex", imagen: "imagenes/completos/black_orchid.webp", alt: "Black Orchid", precio: "$3,200" },
  ...
  { casa: "Carolina Herrera", categoria: "disenador", nombre: "Very Good Girl Estuche 3 Piezas", concentracion: "EDP", genero: "Dama", esSet: true, contenido: ["EDP 80ml", "Loción corporal 100ml", "Miniatura 10ml"], imagen: "imagenes/completos/very_good_girl_estuche.webp", alt: "Very Good Girl Estuche 3 Piezas", precio: "$3,250" },
  { casa: "Salvatore Ferragamo", categoria: "disenador", nombre: "Signorina Estuche 3 Piezas", concentracion: "EDP", genero: "Dama", esSet: true, contenido: ["EDP 100ml", "Loción corporal 50ml", "Miniatura 15ml"], imagen: "imagenes/completos/signorina_estuche.webp", alt: "Signorina Estuche 3 Piezas", precio: "$2,300" },
  { casa: "Carolina Herrera", categoria: "disenador", nombre: "Good Girl Estuche 3 Piezas", concentracion: "EDP", genero: "Dama", esSet: true, contenido: ["EDP 80ml", "Loción corporal 100ml", "Miniatura 10ml"], imagen: "imagenes/completos/good_girl_estuche.webp", alt: "Good Girl Estuche 3 Piezas", precio: "$3,150" },
  { casa: "Jean Paul Gaultier", categoria: "disenador", nombre: "Le Beau Estuche 2 Piezas", concentracion: "EDT", genero: "Caballero", esSet: true, contenido: ["EDT 125ml", "Miniatura 10ml"], imagen: "imagenes/completos/le_beau_estuche.webp", alt: "Le Beau Estuche 2 Piezas", precio: "$2,499" },
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "One Million Estuche 3 Piezas", concentracion: "EDT", genero: "Caballero", esSet: true, contenido: ["EDT 100ml", "Desodorante 150ml", "Miniatura 10ml"], imagen: "imagenes/completos/one_million_estuche.webp", alt: "One Million Estuche 3 Piezas", precio: "$2,350" },
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "Invictus Victory Estuche 2 Piezas", concentracion: "EDP", genero: "Caballero", esSet: true, contenido: ["EDP 100ml", "Shampoo 100ml"], imagen: "imagenes/completos/invictus_victory_estuche.webp", alt: "Invictus Victory Estuche 2 Piezas", precio: "$2,750" },
  { casa: "Jean Paul Gaultier", categoria: "disenador", nombre: "Le Male Estuche 3 Piezas", concentracion: "EDT", genero: "Caballero", esSet: true, contenido: ["EDT 125ml", "Desodorante 150ml", "Gel de baño 75ml"], imagen: "imagenes/completos/le_male_estuche.webp", alt: "Le Male Estuche 3 Piezas", precio: "$2,450" },
  { casa: "Paco Rabanne", categoria: "disenador", nombre: "Invictus Estuche 3 Piezas", concentracion: "EDT", genero: "Caballero", esSet: true, contenido: ["EDT 100ml", "Desodorante 150ml", "Miniatura 10ml"], imagen: "imagenes/completos/invictus_estuche.webp", alt: "Invictus Estuche 3 Piezas", precio: "$2,250" },
  { casa: "Carolina Herrera", categoria: "disenador", nombre: "Bad Boy Elixir Estuche 3 Piezas", concentracion: "EDP", genero: "Caballero", esSet: true, contenido: ["EDP 100ml", "Gel de baño 100ml", "Miniatura 10ml"], imagen: "imagenes/completos/bad_boy_elixir_estuche.webp", alt: "Bad Boy Elixir Estuche 3 Piezas", precio: "$2,450" },
  { casa: "Carolina Herrera", categoria: "disenador", nombre: "Bad Boy Cobalt Estuche 3 Piezas", concentracion: "EDP", genero: "Caballero", esSet: true, contenido: ["EDP 100ml", "Gel de baño 100ml", "Miniatura 10ml"], imagen: "imagenes/completos/bad_boy_cobalt_estuche.webp", alt: "Bad Boy Cobalt Estuche 3 Piezas", precio: "$2,550" },
  { casa: "Carolina Herrera", categoria: "disenador", nombre: "Bad Boy Estuche 3 Piezas", concentracion: "EDT", genero: "Caballero", esSet: true, contenido: ["EDT 100ml", "Gel de baño 100ml", "Miniatura 10ml"], imagen: "imagenes/completos/bad_boy_estuche.webp", alt: "Bad Boy Estuche 3 Piezas", precio: "$2,450" }
];
